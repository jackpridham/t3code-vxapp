...
| [`@Docs/@TechnicalDocs/t3code-vxapp/agents-authority-startup-errors.md`](@Docs/@TechnicalDocs/t3code-vxapp/agents-authority-startup-errors.md) | Startup-facing `agents-vxapp` authority error surfacing and the no-local-fallback caller boundary.                 |
...
| [`@Docs/@TechnicalDocs/t3code-vxapp/audit_report_t3code-vxapp.md`](@Docs/@TechnicalDocs/t3code-vxapp/audit_report_t3code-vxapp.md)             | Documentation audit for the `019-3` startup-error companion lane.                                                  |
