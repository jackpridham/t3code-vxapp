import workerRuntimeCatalog from "~/features/vxapp/workerRuntime/__fixtures__/catalog.json";
import apiServicesLedgerHardeningR1ContextPlan from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/api-services-ledger-hardening-r1/context-plan.json";
import apiServicesLedgerHardeningR1DispatchContract from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/api-services-ledger-hardening-r1/dispatch-contract.json";
import apiServicesLedgerHardeningR1InstalledPacks from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/api-services-ledger-hardening-r1/installed-packs.json";
import apiServicesLedgerHardeningR1InstructionStackAudit from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/api-services-ledger-hardening-r1/instruction-stack-audit.json";
import partymoreSlaveMobileRuntimeBookingFollowthroughA1ContextPlan from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/partymore-slave-mobile-runtime-booking-followthrough-a1/context-plan.json";
import partymoreSlaveMobileRuntimeBookingFollowthroughA1DispatchContract from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/partymore-slave-mobile-runtime-booking-followthrough-a1/dispatch-contract.json";
import partymoreSlaveMobileRuntimeBookingFollowthroughA1InstalledPacks from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/partymore-slave-mobile-runtime-booking-followthrough-a1/installed-packs.json";
import partymoreSlaveMobileRuntimeBookingFollowthroughA1InstructionStackAudit from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/partymore-slave-mobile-runtime-booking-followthrough-a1/instruction-stack-audit.json";
import partymoreVueOrderCreateAdminParityR2ContextPlan from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/partymore-vue-order-create-admin-parity-r2/context-plan.json";
import partymoreVueOrderCreateAdminParityR2DispatchContract from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/partymore-vue-order-create-admin-parity-r2/dispatch-contract.json";
import partymoreVueOrderCreateAdminParityR2InstalledPacks from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/partymore-vue-order-create-admin-parity-r2/installed-packs.json";
import partymoreVueOrderCreateAdminParityR2InstructionStackAudit from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/partymore-vue-order-create-admin-parity-r2/instruction-stack-audit.json";
import slaveSiteCrudFoundationVueI1ContextPlan from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/slave-site-crud-foundation-vue-i1/context-plan.json";
import slaveSiteCrudFoundationVueI1DispatchContract from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/slave-site-crud-foundation-vue-i1/dispatch-contract.json";
import slaveSiteCrudFoundationVueI1InstalledPacks from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/slave-site-crud-foundation-vue-i1/installed-packs.json";
import slaveSiteCrudFoundationVueI1InstructionStackAudit from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/slave-site-crud-foundation-vue-i1/instruction-stack-audit.json";
import storesManagedTargetAgentsC1ContextPlan from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/stores-managed-target-agents-c1/context-plan.json";
import storesManagedTargetAgentsC1DispatchContract from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/stores-managed-target-agents-c1/dispatch-contract.json";
import storesManagedTargetAgentsC1InstalledPacks from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/stores-managed-target-agents-c1/installed-packs.json";
import storesManagedTargetAgentsC1InstructionStackAudit from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/stores-managed-target-agents-c1/instruction-stack-audit.json";
import storesManagedTargetAgentsI1ContextPlan from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/stores-managed-target-agents-i1/context-plan.json";
import storesManagedTargetAgentsI1DispatchContract from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/stores-managed-target-agents-i1/dispatch-contract.json";
import storesManagedTargetAgentsI1InstalledPacks from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/stores-managed-target-agents-i1/installed-packs.json";
import storesManagedTargetAgentsI1InstructionStackAudit from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/stores-managed-target-agents-i1/instruction-stack-audit.json";
import storesManagedTargetScriptsC1ContextPlan from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/stores-managed-target-scripts-c1/context-plan.json";
import storesManagedTargetScriptsC1DispatchContract from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/stores-managed-target-scripts-c1/dispatch-contract.json";
import storesManagedTargetScriptsC1InstalledPacks from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/stores-managed-target-scripts-c1/installed-packs.json";
import storesManagedTargetScriptsC1InstructionStackAudit from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/stores-managed-target-scripts-c1/instruction-stack-audit.json";
import storesManagedTargetScriptsI1ContextPlan from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/stores-managed-target-scripts-i1/context-plan.json";
import storesManagedTargetScriptsI1DispatchContract from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/stores-managed-target-scripts-i1/dispatch-contract.json";
import storesManagedTargetScriptsI1InstalledPacks from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/stores-managed-target-scripts-i1/installed-packs.json";
import storesManagedTargetScriptsI1InstructionStackAudit from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/stores-managed-target-scripts-i1/instruction-stack-audit.json";
import storesManagedTargetScriptsProbeContextPlan from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/stores-managed-target-scripts-probe/context-plan.json";
import storesManagedTargetScriptsProbeDispatchContract from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/stores-managed-target-scripts-probe/dispatch-contract.json";
import storesManagedTargetScriptsProbeInstalledPacks from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/stores-managed-target-scripts-probe/installed-packs.json";
import storesManagedTargetScriptsProbeInstructionStackAudit from "~/features/vxapp/workerRuntime/__fixtures__/snapshots/stores-managed-target-scripts-probe/instruction-stack-audit.json";
