    ...
    execute: (row) =>
      sql`
        ...
        DO UPDATE SET
          ...
          kind = excluded.kind,
          sidebar_parent_project_id = excluded.sidebar_parent_project_id,
          current_session_root_thread_id = excluded.current_session_root_thread_id,
