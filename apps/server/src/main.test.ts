...
const testLayer = Layer.mergeAll(
  ...
  Layer.succeed(ProjectionOperationalQuery, {
    ...
    getProjectFullById: () => Effect.die("unexpected getProjectFullById"),
    ...
    listThreadCheckpoints: () => Effect.die("unexpected listThreadCheckpoints"),
    listThreadActivities: () => Effect.die("unexpected listThreadActivities"),
    listThreadSessions: () => Effect.die("unexpected listThreadSessions"),
    listOrchestratorWakes: () => Effect.die("unexpected listOrchestratorWakes"),
