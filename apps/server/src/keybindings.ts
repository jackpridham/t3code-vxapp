...
export const DEFAULT_KEYBINDINGS: ReadonlyArray<KeybindingRule> = [
  ...
  { key: "mod+shift+o", command: "chat.new", when: "!terminalFocus && !ideMode" },
  { key: "mod+shift+n", command: "chat.newLocal", when: "!terminalFocus" },
  { key: "ctrl+shift+c", command: "ide.changes.focus", when: "ideMode" },
  { key: "ctrl+shift+e", command: "ide.explorer.toggle", when: "ideMode" },
  { key: "ctrl+shift+t", command: "ide.threads.focus", when: "ideMode" },
  { key: "ctrl+alt+m", command: "ide.manager.toggle", when: "ideMode" },
  { key: "ctrl+alt+b", command: "ide.chat.toggle", when: "ideMode" },
  { key: "ctrl+shift+v", command: "ide.markdownPreview.toggle", when: "ideMode" },
  { key: "ctrl+shift+d", command: "ide.diff.toggle", when: "ideMode" },
  { key: "ctrl+alt+e", command: "ide.chat.executive", when: "ideMode" },
  { key: "ctrl+alt+o", command: "ide.chat.orchestrator", when: "ideMode" },
  { key: "mod+o", command: "editor.openFavorite", when: "!ideMode" },
