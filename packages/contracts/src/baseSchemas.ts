...
export const ProgramId = makeEntityId("ProgramId");
export type ProgramId = typeof ProgramId.Type;
export const ProgramNotificationId = makeEntityId("ProgramNotificationId");
export type ProgramNotificationId = typeof ProgramNotificationId.Type;
export const CtoAttentionId = makeEntityId("CtoAttentionId");
export type CtoAttentionId = typeof CtoAttentionId.Type;
