...
import {
  ...
  isAgentsVxappOwnedCommandType,
  rejectAgentsVxappOwnedCommand,
...
> {
  if (isAgentsVxappOwnedCommandType(command.type)) {
    return yield* rejectAgentsVxappOwnedCommand({ command });
  }
